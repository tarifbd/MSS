...
export const GlobalNetwork = () => {
    ...
    return (
        <section ref={ref} className={`py-20 md:py-32 bg-[#0f172a] relative overflow-hidden transition-all duration-1000 ${isVisible ? 'opacity-100 animate-rotate-in' : 'opacity-0'}`}>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-indigo-500/30 transition-colors">
