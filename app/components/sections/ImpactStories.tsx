...
export const ImpactStories = () => {
    ...
    return (
        <section ref={ref} className={`py-20 md:py-32 bg-[#020617] border-t border-white/5 relative overflow-hidden transition-all duration-1000 ${isVisible ? 'opacity-100 animate-slide-in-right' : 'opacity-0 translate-x-10'}`}>
            <Container>
                ...
                <div className="flex lg:grid lg:grid-cols-3 gap-6 overflow-x-auto pb-8 lg:pb-0 snap-x snap-mandatory no-scrollbar">
                    {cases.map((item, i) => (
                        <div key={i} className="snap-center flex-shrink-0 w-[85vw] md:w-[400px] lg:w-auto glass-panel p-8 rounded-2xl border border-white/5 hover:border-indigo-500/30 transition-all duration-300 group">
